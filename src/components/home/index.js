  ...
  return (
    <FlexContainer direction="column" className={styles.container}>
      <div className={styles.placeholder}>
        ...
        <p className={styles.text}>
          I really just want to play with technology that allows people to play
          an online card game together and I thought with my excitement for
          Keyforge this was the perfect time to start. Additionally, I don&#39;t
          just want to <i>play</i> keyforge. I want to learn and get better at
          keyforge. My goal for this website is to build in a{' '}
          <b>replay system</b> to help locate the moment the game when things
          went wrong and an <b>in-depth deck statistics</b> section as you play
          your decks online against your friends.
        </p>
        <p className={styles.text}>
          If this sounds at all interesting to you and would like to help out on
          the development side, the project is{' '}
          <a
          ...
          . If you'd like to contact me directly, you can find me on discord at{' '}
          <b>@warpig#9483</b>.
        </p>
      </div>
